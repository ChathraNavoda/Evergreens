...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dgpwtxicj', 'jbtmpt5e');
      ...
      httpErrorHandle(
          ...
          context: context,
          onSuccess: () {
            showSnackBar(context, 'Product added succussefully!');
  ...
  //get all products
  Future<List<Product>> fetctAllProducts(BuildContext context) async {
    final userProvider = Provider.of<UserProvider>(context, listen: false);
